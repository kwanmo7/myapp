...
public class MyUserDetailsService01 implements UserDetailsService {
  private static final Log log = LogFactory.getLog(MyUserDetailsService01.class);

  // DBMB에서 사용자 정보를 찾아주는 service 객체
  private MemberService memberService;

  public MyUserDetailsService01(MemberService memberService) {
