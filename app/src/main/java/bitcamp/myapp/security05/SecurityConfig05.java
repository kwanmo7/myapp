...
public class SecurityConfig05 {
  private static final Log log = LogFactory.getLog(SecurityConfig05.class);
  
  public SecurityConfig05(){
...
//  @Bean
  public UserDetailsService userDetailsService(MemberService memberService) {
    ...
    return new MyUserDetailsService03(memberService);
  }
...
//  @Bean
  public PasswordEncoder passwordEncoder(){
    return new SimplePasswordEncoder02();
  }
}
