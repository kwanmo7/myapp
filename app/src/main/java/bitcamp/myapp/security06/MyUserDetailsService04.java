...
public class MyUserDetailsService04 implements UserDetailsService {
  private static final Log log = LogFactory.getLog(MyUserDetailsService04.class);

  // DBMB에서 사용자 정보를 찾아주는 service 객체
  private MemberService memberService;

  public MyUserDetailsService04(MemberService memberService) {
